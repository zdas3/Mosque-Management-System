        ...
        <div className="relative min-h-screen flex items-center justify-center overflow-hidden bg-[#050505]">
            ...
            <div className="absolute inset-0 z-0 overflow-hidden">
                ...
                <motion.div
                    ...
                    className="absolute -top-[20%] -left-[10%] w-[50vw] h-[50vw] rounded-full bg-[#008f5d]/20 blur-[150px] mix-blend-screen pointer-events-none"
                />
                <motion.div
                    animate={{ rotate: -360, scale: [1, 1.2, 1] }}
                    transition={{ duration: 25, repeat: Infinity, ease: "linear" }}
                    className="absolute top-[10%] -right-[10%] w-[40vw] h-[40vw] rounded-full bg-[#d4af37]/15 blur-[120px] mix-blend-screen pointer-events-none"
                />
                <motion.div
                    animate={{ y: [0, -50, 0] }}
            ...
            <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-32 pb-20 grid lg:grid-cols-2 gap-16 items-center">
                ...
                <div className="text-left space-y-8">
                    ...
                    >
                        Izzathul <br />
                        <span className="text-transparent bg-clip-text bg-gradient-to-r from-[#00eb9b] via-[#008f5d] to-[#d4af37] drop-shadow-[0_0_15px_rgba(0,143,93,0.3)]">
                            Islam
                        </span>
                    </motion.h1>
                    ...
                    >
                        <Link href="#timings" className="group w-full sm:w-auto px-8 py-4 rounded-full bg-white text-[#008f5d] font-bold text-lg hover:bg-gray-100 transition-all flex items-center justify-center gap-3 shadow-[0_0_30px_rgba(255,255,255,0.2)] hover:shadow-[0_0_40px_rgba(255,255,255,0.4)] transform hover:-translate-y-1">
                        ...
                        <Link href="#contribute" className="group w-full sm:w-auto px-8 py-4 rounded-full bg-white/5 text-white font-bold text-lg border border-white/10 hover:bg-white/10 backdrop-blur-xl transition-all flex items-center justify-center gap-3 transform hover:-translate-y-1">
                            Contribute <Heart className="w-5 h-5 text-[#d4af37] group-hover:scale-110 transition-transform" />
                        </Link>
                    </motion.div>
                </div>
                ...
                >
                    <div className="absolute inset-0 bg-gradient-to-tr from-[#008f5d]/20 to-transparent rounded-[3rem] border border-white/10 backdrop-blur-sm shadow-2xl transform rotate-3" />
                    ...
                    >
                        <div className="w-12 h-12 rounded-full bg-gradient-to-br from-[#d4af37] to-amber-600 flex items-center justify-center mb-4">
                    ...
                    >
                        <div className="w-12 h-12 rounded-full bg-gradient-to-br from-[#008f5d] to-[#004d33] flex items-center justify-center mb-4 shadow-[0_0_15px_rgba(0,143,93,0.5)]">
