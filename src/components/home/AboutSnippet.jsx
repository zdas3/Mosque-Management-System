...
const blocks = [
    ...
    },
    {
        ...
        icon: Users,
        color: 'from-[#f59e0b] to-yellow-300',
...
export default function AboutSnippet() {
    return (
        <section className="py-32 bg-[#0a0a0a] relative overflow-hidden">
            ...
            <div className="absolute top-1/2 left-0 w-[500px] h-[500px] bg-[#f59e0b]/5 blur-[150px] -translate-y-1/2 translate-x-[-20%] rounded-full pointer-events-none" />
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
                    ...
                    >
                        <h2 className="text-4xl md:text-5xl font-black text-white mb-6 font-outfit leading-tight tracking-tight">
                            More Than Just a <span className="text-transparent bg-clip-text bg-gradient-to-r from-[#0d9488] to-[#065f46]">Place of Worship</span>
                        </h2>
                    ...
                    >
                        ...
                        <div className="absolute inset-0 rounded-[3rem] border border-white/5 outline outline-1 outline-[#065f46]/20 -outline-offset-2 z-20 pointer-events-none" />
